# research-plan.md — mind-weapon

The search queries executed against vendor docs and primary sources during the initial weapon forge. Each query → one dated `2026-04-25-<slug>.md` note. Plus the Vectara NAACL 2025 chunking note as carried-over universal research.

---

## Search queries executed during the initial weapon forge
...
## Carried over from retired ai-platform-weapon
...
- **Implications for the deploying product / mind-weapon guides.**
