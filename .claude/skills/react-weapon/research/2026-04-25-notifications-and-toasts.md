...
- Worker / cron / queue infrastructure that fans out cross-channel notifications is handed off to `devops-guardian`.
- Push token storage / rotation / auth posture handed off to `security-guardian`.
