...
- This article provides the metric context for `guides/05-cls-elimination.md` and `guides/06-performance-checklist.md`. The 0.1 target is the quantitative CLS budget weapon-forge should encode as the pass/fail threshold.
