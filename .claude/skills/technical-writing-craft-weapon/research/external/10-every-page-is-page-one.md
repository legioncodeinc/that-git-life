...
- The EPPO "link richly" principle is a structural recommendation that interacts with the Angel's scope boundary: the Angel can recommend links, but cannot restructure the site navigation (that is docs-site-guardian's job).
