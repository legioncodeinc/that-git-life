...
This example is the canonical counter-case to the "always recommend GitHub Flow" default. The Angel must be able to recognize when GitFlow is the right answer and explain why clearly — including why feature flags don't fully substitute for release branches in this specific context.
