...
- **Directly informs guides/06-verification-checklist.md**: The application threshold is at 75 servers (not 100). Bots should begin the process at 75 to avoid hitting the hard wall at 100. discord-bot-guardian's critical directive "Surface the bot-verification deadline before 75 servers, not at 100" is confirmed by official docs.
