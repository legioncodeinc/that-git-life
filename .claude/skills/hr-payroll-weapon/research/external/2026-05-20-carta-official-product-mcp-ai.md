...
- **Carta Law acquisition (May 2026)** expands Carta's surface into legal services (LP transfers, KYC, fund documents) — note this in `guides/05-carta-handoff.md` as a future expansion vector but flag that hr-payroll-guardian does NOT advise on legal services beyond the existing legal-advice fence
- The "Contact for pricing" model for Build/Grow/Scale tiers means weapon-forge cannot give concrete pricing in the recommendation; instead, frame it as "free until you outgrow Launch, then a sales conversation" — this is actually a strong argument for Carta over alternatives
...
- The Granola AI notetaker integration into Carta CRM is tangential to hr-payroll-weapon's scope but useful context for understanding the broader Carta-AI ecosystem trajectory
