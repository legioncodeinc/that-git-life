...
**For weapon-forge:** The clear 2026 standard is: LinearB for enterprise PR-lifecycle and DORA metrics; ActionableAgile for Kanban/flow teams needing histograms + Monte Carlo inputs. Both are Jira-centric; Linear.app has its own built-in cycle time reports.
