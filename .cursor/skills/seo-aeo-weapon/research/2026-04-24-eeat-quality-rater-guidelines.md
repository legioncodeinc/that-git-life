...
- The Angel must flag any content page missing author attribution as a Critical finding for YMYL topics, High otherwise.
- Cross-reference: `library-guardian` owns editorial policy documents; the Angel flags missing policy pages but doesn't author them.
