...
Procedural arsenal for `preact-guardian` — the Legion Army's Preact 11 specialist. This weapon encodes the opinionated decision framework, the signals API (v2), the `preact/compat` compatibility surface, the third-party embed pattern, and the Astro/Fresh integration playbooks.
...
*Forged by `weapon-forge` from `preact-guardian-command-brief.md` and `research/`. Part of the Legion AI Tools Factory by [Mario Aldayuz a.k.a @thenotoriousllama](https://github.com/thenotoriousllama).*
