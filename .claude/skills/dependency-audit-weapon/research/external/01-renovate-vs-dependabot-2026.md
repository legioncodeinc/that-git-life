...
- **Contradiction to resolve:** The backlog brief says "Prefer Renovate over Dependabot for teams that need automerge or grouping" - the research confirms this is accurate and the weapon should encode it as the decision rule, not merely a preference.
