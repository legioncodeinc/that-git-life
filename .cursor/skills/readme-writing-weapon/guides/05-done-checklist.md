...
Run this checklist at the end of every `readme-writing-guardian` session before declaring the README complete. Every item must pass before the file is emitted or committed.
...
| 10 | **README is under 1,500 words** | Word count check; if 1,500–2,000, warn; if >2,000, flag for `library-guardian` handoff | Trim or extract |
...
```markdown
<!-- TODO: readme-writing-guardian: badge for CI is pointing to deleted branch; update to main -->
```
