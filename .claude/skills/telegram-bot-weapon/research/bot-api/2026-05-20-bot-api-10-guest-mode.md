...
- Managed Bots (Bot API 9.6) adds a new use case for `telegram-bot-guardian`: bots that spawn and manage other bots via `getManagedBotToken` / `replaceManagedBotToken`.
