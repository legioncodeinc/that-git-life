...
Inherits the repo default. If the repo is properly configured (Part 1 above), this is read-only. If the repo isn't configured, this could be permissive — so devops-weapon enforces explicit per-job blocks regardless.
