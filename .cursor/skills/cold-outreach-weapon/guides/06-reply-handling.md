...
- If they threaten legal action regarding GDPR or CAN-SPAM: escalate to `security-guardian` with the specific complaint details
...
Route CRM schema design to `db-guardian` if the user needs a formal data model.
