# Research Summary — icon-system-weapon
...
2. **Iconify API rate limits for self-hosted apps** — The public Iconify API has no documented rate limit as of 2026-05 but Iconify recommends self-hosting the API server for production apps. This is out of scope for this weapon but should be flagged in the library-selection matrix.
