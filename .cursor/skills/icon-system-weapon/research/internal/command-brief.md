# Command Brief Extracts — icon-system-guardian

Source: `ai-tools/command-briefs/icon-system-guardian-command-brief.md`
...
Does NOT own: design tokens for icon size or color (ux-ui-guardian), general React bundle optimization beyond icon imports (devops-guardian), or build tooling configuration for SVG sprite generation (devops-guardian).
