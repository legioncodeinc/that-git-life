...
- The geofencing change (removed as approved foreground services use case) is a breaking change for location-based apps — weapon-forge should surface this prominently.
