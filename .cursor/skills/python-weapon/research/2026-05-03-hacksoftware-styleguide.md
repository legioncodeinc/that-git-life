...
- HackSoftware's API guidance pre-dates Django Ninja popularity — they recommend `APIView` + serializers. python-weapon adapts this: **services + selectors stay; the API layer is Django Ninja with Pydantic schemas instead of DRF serializers.**
