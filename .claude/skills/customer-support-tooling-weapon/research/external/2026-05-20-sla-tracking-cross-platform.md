...
Web search retrieved authoritative docs from Plain, Intercom, and Help Scout for SLA configuration. This file synthesizes the three official sources into a cross-platform comparison for weapon-forge.
