...
- **Contradiction to monitor:** sbomify-action disables Trivy by default ("temporarily disabled due to security vulnerabilities") - weapon should not recommend Trivy as a primary SBOM generator until this is resolved.
