# Research Summary — terminal-bash-weapon
...
1. Should the Weapon cover shell prompt configuration (Starship vs p10k) as a full guide, or only a mention? (Low priority for shallow tier; flag for user decision.)
...
3. Does the team use a dotfile manager (chezmoi, yadm, stow)? The Weapon covers manual dotfiles; a separate guide may be warranted.
