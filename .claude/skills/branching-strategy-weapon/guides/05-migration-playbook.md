...
1. **Enable main branch protection.** Require PR reviews before merge. Block force-pushes to main. Route the ruleset configuration to `github-repo-health-guardian`.
