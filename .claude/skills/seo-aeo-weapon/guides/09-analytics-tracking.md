...
GA4 collects IP addresses and cookie identifiers. GDPR / CCPA require a consent banner in applicable regions. The Weapon does not ship a consent UI — coordinate with product/legal. `security-guardian` tracks the consent requirement.
