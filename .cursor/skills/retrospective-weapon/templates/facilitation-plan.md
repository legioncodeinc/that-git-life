...
- [ ] Psychological safety pre-check completed (see `guides/02-psychological-safety.md`)
- [ ] Previous retro action items pulled up and ready for opening review
- [ ] Board/tool prepared (columns/prompts matching the chosen format)
- [ ] Timer set
- [ ] Anonymous input enabled if safety score < 3.5/5
...
Purpose: lower activation energy, make it safe to speak.
...
Synthesis technique: [affinity mapping | silent grouping | dot voting round 1]
...
Top themes to address: [fill after voting]
...
Use `templates/action-items.md` to record outputs.
...
- [ ] Action items added to sprint backlog (not just retro notes)
- [ ] Retro notes published to `library/retros/[YYYY-MM-DD]-retro-[sprint].md`
- [ ] Follow-through rate logged
- [ ] Next retro date confirmed

---

*Fill in before the session. Update during. Archive after. Part of `retrospective-weapon`.*
