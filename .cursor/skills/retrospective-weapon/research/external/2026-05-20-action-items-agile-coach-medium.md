---
source_url: https://uragilecoach.medium.com/your-retro-is-working-your-follow-through-isnt-2a1cfc734d0c
...
# Your Retro Is Working, Your Follow-Through Isn't
...
**The 3-question filter:** Before any action item is picked up after the retro, it must answer these three questions in under 60 seconds:
1. Who owns this?
...
**Opening ritual:** The author now always starts with last sprint's action items before anything else. "Before I open a new retro, I open the previous retro's closed action list and ask: how many of these did we actually close? For the ones we closed, did they help? What did we learn?"

**Retro action closure rate as a metric:** Teams that start each retrospective by reviewing the previous sprint's action items complete their improvement items at a meaningfully higher rate. One case study: teams went from 40% closure to 85% closure in 3 sprints simply because someone started showing the number at the start of each session.
...
- "The format is not what makes a retrospective work. The follow-through is."

## Annotations for weapon-forge

- The 3-question filter is the single most actionable tool in this research sweep. It should appear in both `guides/04-action-items.md` and `templates/action-items.md` as the live facilitation check before accepting any action item.
- The 50% completion rate statistic (with survey backing) is the evidence weapon-forge needs to justify the weapon's emphasis on follow-through over format selection.
