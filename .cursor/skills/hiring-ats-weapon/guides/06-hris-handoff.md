...
HRIS configuration depth beyond the ATS handoff interface belongs to a future `hris-guardian`. This weapon stops at:

- The field mapping between ATS and HRIS
- The webhook trigger configuration
- The offer-to-hire flow

It does NOT cover: setting up Rippling departments, payroll groups, benefits plans, compensation bands, or IT provisioning workflows. Escalate these to `hris-guardian` (when available) or flag as out of scope.
