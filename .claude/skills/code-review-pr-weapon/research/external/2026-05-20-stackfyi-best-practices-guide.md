...
- **Contradiction note**: This guide uses four tiers (blocking, suggestion, nit, question) while some others use three. The Angel should standardize on three user-visible tiers (blocker, suggestion, thought) and treat "question" as a sub-type of "thought."
