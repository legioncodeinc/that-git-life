...
Preact is the right choice in a small number of concrete scenarios. This guide is the entry point for all `preact-guardian` invocations involving evaluation or architecture decisions. Read it before any other guide.
