...
- expressive-code is the recommended choice when Starlight is the platform (docs-site-guardian domain handoff)
- After platform decision, this weapon implements the highlighting config
