...
2. **Rotate the compromised credential.** Even after removal from history, assume the credential is compromised. Rotate it immediately. Escalate to `security-guardian` for this step.
