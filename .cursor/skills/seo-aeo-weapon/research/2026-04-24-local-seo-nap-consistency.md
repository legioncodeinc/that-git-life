...
- The Angel's action flow for a local-business context prioritizes this guide; otherwise it's lower-priority.
- The brief explicitly flags: "Should `local-seo` be a conditionally-activated guide?" — current answer: always authored, conditionally applied based on the target site's business context (Angel decides during scoping).
