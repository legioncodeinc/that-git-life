...
- **Open question for weapon-forge to address:** When PEP 751 lockfiles gain wider tooling support, the provenance verification story for Python changes significantly. The guide should note this as "watch this space" with the PEP 751 reference.
