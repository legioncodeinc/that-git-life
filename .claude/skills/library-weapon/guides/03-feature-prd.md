...
library/requirements/backlog/prd-<###>-<kebab-slug>/
  ...
  qa/
    prd-<###>-<kebab-slug>-qa.md                 QA report (authored by quality-guardian)
```
...
Create `qa/` inside the PRD folder on creation (empty). `quality-guardian` writes `prd-<###>-<slug>-qa.md` there when a QA audit is requested. You own the structure; you never write QA content.
