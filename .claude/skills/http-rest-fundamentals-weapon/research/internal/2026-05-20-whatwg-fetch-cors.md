...
- The "wildcard + credentials = Critical" directive in the angel's identity matches the spec exactly — weapon-forge should encode this as a non-negotiable Critical-severity finding.
