...
This folder accumulates audit reports produced by `product-feedback-roadmap-guardian` when invoked for a full feedback-system audit.
...
This folder is empty. Reports are created on demand by `product-feedback-roadmap-guardian` when a user requests an audit. Save reports here for team reference and future comparisons.
