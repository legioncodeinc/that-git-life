...
- The second-person rule ("you" not "we") maps directly to the Angel's voice-and-tone check. `guides/03-voice-and-tone.md` should cite Google as the canonical authority for this preference.
- "Conditions before instructions" is a specific, testable rule the Angel can flag in reviews: "If you want to do X, run Y" - not "Run Y if you want to do X."
...
- Sentence case for headings is a common violation in developer docs; the Angel should flag Title Case headings as a Suggestion-level finding.
