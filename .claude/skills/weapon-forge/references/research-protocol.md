...
4. A query for the adjacent topics the Angel might encounter
...
<Your annotations on how this fits the Angel's job>
```
...
2. Handle the common cases the Angel will see.
3. Recognize when the Angel is in unfamiliar territory (so it can escalate).

As a rough heuristic: three to seven research files per Weapon is typical. Less suggests the research was superficial; more suggests the Weapon's scope is too broad and should have been split into two Angels at brief time.
