...
This folder accumulates audit and session reports produced by `typography-font-guardian`.
...
7. **Handoff notes** - what `ux-ui-guardian` and `devops-guardian` need to know

---

*Reports are written inline by the guardian and optionally persisted here when the user says "save the report" or "persist the audit".*
