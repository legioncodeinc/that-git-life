...
Note: GBP, directories, and review management are marketing-ops territory — the Angel flags the need; execution is elsewhere.
...
**Out of scope for this Weapon.** Informational checklist only — the Angel does not execute outreach. Flag to marketing.
