...
The `<NNNN>` placeholder is filled by the TS driver in the post-pass (per user decision 2026-04-29 on parallel-safe ADR allocation). Wiki-guardian writes `adr_number: <pending>` and uses a temp slug filename until the driver renames.
