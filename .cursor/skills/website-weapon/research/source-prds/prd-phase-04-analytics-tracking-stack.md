...
- **R-1:** CSP header from Phase 2 must allow `https://www.googletagmanager.com` for GA4. Verify the Phase 2 CSP baseline includes this. If CSP is tightened by `security-guardian`, re-verify GA4 loads.
