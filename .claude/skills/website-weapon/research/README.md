...
This is populated by `scripture-historian` (Phase 1.5 of the factory pipeline). The source PRDs in this folder reference Payload high-level architecture; detailed Payload implementation claims should cite `cms-payload-weapon/research/` files.
