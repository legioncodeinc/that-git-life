...
- Note: Nygard's original template does not include "Alternatives Considered" - that section was added by later practitioner evolution (MADR, etc.). Weapon-forge should note this evolution.
