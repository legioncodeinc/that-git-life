...
This folder is the canonical worked example for the `code-forensics-weapon` skill. It documents the Example Booking Co. matter (Sarah Bennett / Example Booking Co. LLC v. ADA + DevPipe), completed May 2026.
...
For the Weapon's user, the Example Booking Co. V3 example shows:
