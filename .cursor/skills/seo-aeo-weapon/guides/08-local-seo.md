...
External directory audit is out of scope for this Weapon (marketing ops territory) — the Angel flags the need; execution is elsewhere.
...
GBP is a marketing-ops concern. The Angel's job is to ensure the website is ready to benefit from GBP; managing GBP itself is out of scope.
