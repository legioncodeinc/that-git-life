...
- Platform-specific paths to pull these metrics vary by KB platform - weapon-forge should research per-platform analytics tabs for Document360, Help Scout, Intercom, and Zendesk separately
