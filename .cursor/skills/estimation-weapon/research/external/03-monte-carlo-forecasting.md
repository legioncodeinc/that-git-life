...
- Important nuance for weapon-forge: Monte Carlo for throughput-based teams vs. Monte Carlo for task-estimate-based teams are different modes. Document both in the guide.
