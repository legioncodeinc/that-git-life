...
Default in the Weapon templates: **allow all** with a note. The canonical playbook §2.4 allows GPTBot and CCBot explicitly. User sets the policy; the Angel must not silently change it.
