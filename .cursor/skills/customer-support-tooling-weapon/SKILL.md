...
Arsenal for `customer-support-tooling-guardian`. Encodes the decision trees, comparison matrices, configuration templates, and integration wiring guides the Angel reads when invoked.
...
*Forged by `weapon-forge` from `customer-support-tooling-guardian-command-brief.md` and `research/`. Part of the Legion AI Tools Factory by [Mario Aldayuz a.k.a @thenotoriousllama](https://github.com/thenotoriousllama).*
