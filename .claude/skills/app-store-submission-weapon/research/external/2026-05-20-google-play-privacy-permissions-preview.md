...
- The pre-review check announcement (October 27, 2026) is a significant workflow change: Play Console will auto-flag certain permission issues before developers submit. Weapon-forge should note this as a tool in the compliance checklist guide.
