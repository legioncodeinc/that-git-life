...
- The Angel's `robots: { index: false }` sacred-page rule (brief SUBAGENT CRITICAL DIRECTIVES) traces to the canonicalization rules above — a wrong "fix" can accidentally re-expose a deliberately-noindexed staging page.
