...
- The absence of built-in state persistence is a material gap weapon-forge must address — include a localStorage pattern and a database pattern (for cross-device persistence) in the guide.
