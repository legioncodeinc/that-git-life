...
*Forged by weapon-forge from `review-funnels-g2-guardian-command-brief.md` and scripture-historian research (2026-05-20). Part of the Legion AI Tools Factory by [Mario Aldayuz a.k.a @thenotoriousllama](https://github.com/thenotoriousllama).*
