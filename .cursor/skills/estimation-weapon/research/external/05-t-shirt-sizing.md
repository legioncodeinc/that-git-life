...
- The progressive refinement pipeline (T-shirt → story points → hours) is the canonical model for weapon-forge to document
...
- "Now/Next/Later" roadmap format pairing is a 2026-era context that weapon-forge should reference as the current standard for product roadmaps
