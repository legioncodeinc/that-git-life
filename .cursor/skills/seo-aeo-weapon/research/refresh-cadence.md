...
The `seo-aeo-guardian` Angel (on user trigger "refresh seo-aeo research") walks this checklist:
...
The Angel activates this protocol on:
...
Owner: unspecified — the user runs it on cadence. If this Weapon accumulates two consecutive missed reviews (180+ days stale), the Angel should proactively surface the staleness at the start of any new audit invocation.
