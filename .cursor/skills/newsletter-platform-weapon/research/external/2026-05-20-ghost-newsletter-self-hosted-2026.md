...
The practitioner who wrote this runs "fully custom front end + beehiiv backend" - this is the headless newsletter pattern where Beehiiv handles email/growth/monetization but the website is custom-built. This is a legitimate advanced use case for the weapon to document.
