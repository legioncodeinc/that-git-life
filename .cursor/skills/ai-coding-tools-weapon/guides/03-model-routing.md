...
> **TODO: open question** — The exact routing logic for when Cursor uses its proprietary model vs routes to external providers was not fully documented in available sources as of 2026-05-20. Consult `cursor-ide-guardian` for the authoritative current routing behavior.
