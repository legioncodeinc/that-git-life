...
Procedural arsenal for `hr-payroll-guardian`, the Legion AI Army's HR infrastructure and payroll decision specialist. This Weapon encodes the five core decision moments a software startup encounters in its people-ops lifecycle, grounded in 2026-current research.
...
Do NOT load for:
- Performance management, OKRs, 1:1s (no peer Angel covers this yet; defer to library-guardian)
...
*Forged by `weapon-forge` from `hr-payroll-guardian-command-brief.md` and `research/`. Part of the Legion AI Tools Factory by [Mario Aldayuz a.k.a @thenotoriousllama](https://github.com/thenotoriousllama).*
