...
Every PR description the Angel produces contains exactly these six elements. See `guides/01-pr-description.md` for the full authoring guide.
...
**This Angel owns:** PR descriptions, review checklists, review comment quality, PR size evaluation, async review norms, rubber-stamp detection, review culture metrics.
