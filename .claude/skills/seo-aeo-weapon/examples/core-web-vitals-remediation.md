...
**Scenario:** The `/category/apparel` page in the e-commerce audit (`examples/audit-ecommerce-site.md`) fails Core Web Vitals at p75 on mobile: LCP 4.2 s, INP 510 ms, CLS 0.22. The user invokes `seo-aeo-guardian` with "fix the CWV on `/category/apparel`".
