...
**The handoff failure modes weapon-forge must document (guides/06):**
...
- Escalation note for weapon-forge: HRIS configuration depth beyond the ATS handoff interface (setting up Rippling departments, payroll groups, benefits plans) belongs to future `hris-guardian` - this weapon stops at the handoff boundary
