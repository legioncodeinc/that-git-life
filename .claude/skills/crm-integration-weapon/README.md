...
CRM connectivity playbook for `crm-integration-guardian`. This Weapon encodes the decision framework and procedural guides for connecting a product to HubSpot, Salesforce, Pipedrive, Attio, Folk, Close, or Copper.

## What this Weapon encodes
...
Research synthesized from 10 source notes, November 2025 -- May 2026. Key findings in `research/research-summary.md`. Command Brief at `../../command-briefs/crm-integration-guardian-command-brief.md`.
