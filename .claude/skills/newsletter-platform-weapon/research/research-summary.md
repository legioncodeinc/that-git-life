# Research Summary: newsletter-platform-weapon
...
2. **Beehiiv's exact ad network commission rate**: Research confirms Beehiiv takes a commission on Ad Network revenue but does not cite the exact percentage. Sources say "check current rate on beehiiv.com." This number changes as the network grows. weapon-forge should pull from current docs.
