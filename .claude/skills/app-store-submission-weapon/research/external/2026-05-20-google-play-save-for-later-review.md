...
- This is a 2026 workflow improvement that reduces the pain of Google Play's bundled-review model. Weapon-forge should note it in `guides/05-timeline-and-process.md` as a pro tip for release engineering.
