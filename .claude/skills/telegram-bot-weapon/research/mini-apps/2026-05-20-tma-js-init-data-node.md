...
- This package also exists as `@mini-apps/telegram-init-data` (v1.0.0, published June 2025) - may be a repackaging or successor; weapon-forge should check for version alignment.
