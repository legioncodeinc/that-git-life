...
- Critical licensing callout: Intro.js's AGPL v3 is a legal red flag for commercial SaaS. The weapon MUST call this out explicitly with a "check your license" warning.
- Shepherd.js is the weapon's recommended open-source default for full-featured production tours; Driver.js is recommended for lightweight spotlight/highlight use cases.
