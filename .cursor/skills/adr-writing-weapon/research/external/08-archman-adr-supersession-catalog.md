...
- Weapon-forge note: the `migration_deadline` field is a powerful addition over the basic Nygard model. Consider whether the weapon's default Nygard template should include optional migration metadata.
