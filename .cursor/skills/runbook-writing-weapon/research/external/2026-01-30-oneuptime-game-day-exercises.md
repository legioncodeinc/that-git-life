...
- The quarterly program structure (Q1-Q4 themes) is a concrete template weapon-forge can include as a recommended cadence.
- The `runbook_accuracy` metric (observer comparison, 1-5 scale) gives weapon-forge a measurable KPI to embed in the exercise protocol.
...
- The tabletop exercise option is important for teams that cannot inject failures into production-like environments; weapon-forge should include it as a lighter variant in `guides/05-runbook-as-test.md`.
