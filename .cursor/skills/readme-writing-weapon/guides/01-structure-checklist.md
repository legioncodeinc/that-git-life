...
The 2026 consensus section order for a README, with pass/fail criteria for each section. Run this checklist in Step 2 (audit) and Step 7 (final validation) of the weapon procedure.
...
| Over 2,000 words | Flag for extraction; recommend `library-guardian` for docs-site setup |
