...
- **Key message for weapon-forge guides:** "If you are not using S2S postback today, you are already losing attribution on roughly one in three user sessions." This is not a future risk - it is the current operational state.
