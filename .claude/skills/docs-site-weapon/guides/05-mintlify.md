...
Mintlify auto-generates one page per endpoint. Enrich with MDX descriptions in the spec's `description` fields. Route spec authorship to `api-docs-guardian`.
