...
The Scrum Guide 2020 (https://scrumguides.org) is 13 pages. Every normative claim in this weapon traces to it. This guide maps each Scrum Guide requirement to an actionable audit check, using the exact structure: Roles, Events, Artefacts, Commitments.
