...
**Date:** {{YYYY-MM-DD}}
**Auditor:** seo-aeo-guardian (Weapon: seo-aeo-weapon)
...
- [ ] {{e.g., "Hand off to library-guardian for PRD authoring on the 8-week rollout."}}
- [ ] {{e.g., "Schedule 14-day CrUX follow-up against Search Console."}}
- [ ] {{e.g., "Route CSP change through security-guardian before merge."}}
...
The `seo-aeo-weapon` research folder's 90-day refresh cadence:
