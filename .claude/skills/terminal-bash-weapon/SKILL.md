...
The Angel performs seven distinct actions. Each maps to a guide:
...
*Forged by `weapon-forge` from `terminal-bash-guardian-command-brief.md` and research/. Part of the Legion AI Tools Factory by [Mario Aldayuz a.k.a @thenotoriousllama](https://github.com/thenotoriousllama).*
