...
Read before touching anything else. This guide wraps the canonical playbook's §1 (Introduction & Philosophy) with the `seo-aeo-guardian` Angel's directives from the Command Brief.
...
- Marketing copy, keyword research, editorial work → content Angel.
