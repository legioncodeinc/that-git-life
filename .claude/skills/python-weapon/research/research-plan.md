# Research Plan — python-weapon

Forge date: 2026-05-03

## Goal

Ground every active guide in `python-weapon/guides/` against (a) authoritative upstream docs, (b) production-pattern blog posts from teams shipping the canonical stack, and (c) curated style guides. Each research note documents one query's findings, the source URLs, retrieval date, and the specific guides it informs.
