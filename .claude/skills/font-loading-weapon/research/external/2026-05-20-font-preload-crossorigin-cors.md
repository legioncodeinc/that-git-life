...
- The `Vary: Origin` hazard is an advanced edge case relevant to CDN configurations. The weapon should include a note warning against setting `Vary: Origin` on font responses when using preload hints.
...
- The correct preload tag template for `templates/preload-link.md` in the weapon: `<link rel="preload" href="/fonts/inter-variable.woff2" as="font" type="font/woff2" crossorigin>`.
