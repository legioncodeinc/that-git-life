...
The Angel classifies every incoming request into one of three runbook types before applying any template:
...
- If a runbook surfaces a missing deployment procedure, the Angel surfaces it to `devops-guardian` and embeds a placeholder
