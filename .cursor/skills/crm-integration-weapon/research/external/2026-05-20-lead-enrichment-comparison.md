...
- **Critical finding:** Clearbit's original API may be deprecated for non-HubSpot customers. weapon-forge should verify this at https://clearbit.com/docs before authoring the guide. If confirmed deprecated, remove Clearbit from the enrichment comparison entirely.
