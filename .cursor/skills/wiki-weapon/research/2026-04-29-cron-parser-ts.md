...
## Open questions / gaps
- For dynamically-built cron expressions (`buildCron(env.SCHEDULE)`), wiki-guardian can't statically resolve the value — emit a `gap` with the variable name.
