...
- Contradiction with SEO guidance: `seo-aeo-guardian` owns organic keyword strategy, but llms.txt is about AI assistant citation, not traditional search ranking. The boundary is clear: llms.txt = this Angel; meta tags and structured data = seo-aeo-guardian.
