...
- The three co-required resources (clear escalation paths + well-defined procedures + blameless postmortem culture) give weapon-forge a canonical justification for why the weapon must address all three - not just templates.
...
- Cite this source explicitly in SKILL.md's reference section as the foundational anchor for the weapon's principles.
