...
- The 10-connection limit is a critical production constraint weapon-forge must include in the setup guide.
- Weapon-forge should present a clear decision tree: "Will this app be listed in the Slack Marketplace? If yes → HTTP mode. If no → Socket Mode is viable."
