...
A worked before/after example showing how `readme-writing-guardian` audits and rewrites an OSS library README using the structure checklist and badge discipline.
...
## AFTER (readme-writing-guardian output)
