...
- Contradiction to surface: Command Brief says trunk-first as default; this source says GitHub Flow is the 80% answer. For weapon-forge: acknowledge both - GitHub Flow IS trunk-based with a PR review step; the distinction is mostly cultural naming.
