...
- **Open question for weapon-forge**: The article recommends Markdown-only. The Command Brief asks whether `.rst` should be supported. This source supports CommonMark-only for GitHub-hosted projects; make the recommendation explicit in the weapon.
