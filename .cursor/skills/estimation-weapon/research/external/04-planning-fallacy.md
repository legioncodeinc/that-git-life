...
- The Serious CTO Dec 2025 piece is the richest single source with quantitative data - prioritize it for citation in the weapon guides
- Bent Flyvbjerg's "Reference Class Forecasting" and megaprojects research (cited in Command Brief) was not directly retrieved in this pass; weapon-forge should note this and potentially scrape flyvbjerg.org for the canonical reference
