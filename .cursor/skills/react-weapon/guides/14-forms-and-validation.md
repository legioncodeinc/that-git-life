...
- **Visual / token decisions on form fields** → `ux-ui-guardian`.
- **Server Action security review (auth, RBAC, CSRF posture)** → `security-guardian`.
- **Survey product strategy (Formbricks vs Typeform vs build)** → `library-guardian` PRD.
