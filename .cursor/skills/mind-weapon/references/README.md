...
> **These are alternatives we DON'T use; preserved for context only because mind-guardian supersedes the retired ai-platform-guardian.**
...
| `vectara-naacl-2025-chunking-finding.md` | The Vectara NAACL 2025 paper (load-bearing reference for fixed-size chunking — **carried over verbatim from ai-platform-weapon's research** because it's the canonical defense against vendor "semantic chunking" claims) |
