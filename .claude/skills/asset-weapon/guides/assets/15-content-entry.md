...
- **ux-ui-guardian** — owns `maxLength` guidance for UI constraints.
- **library-guardian** — legal documents (`kind: rich` for ToS/Privacy) get cross-linked to versioning PRDs.
- **security-guardian** — `piiLevel` classification review.
