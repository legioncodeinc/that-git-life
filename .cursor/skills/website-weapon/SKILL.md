...
This skill is **predominantly autonomous** by design. The Angel batches clarifying questions at the start, then executes phase by phase with smoke checks and commits.
