...
Next.js 16 is in preview at author time. This Weapon targets Next.js 15 (current stable). `research/react-version-log.md` notes 16 exists; upgrade the Weapon when 16 ships stable.

## None of these block the Weapon's v1 utility.
