...
- Note for weapon-forge: v1.1.0 was a December 2024 release after a long gap. The tool is active but not under heavy development velocity. The `adr/adr-tools` repo notes log4brains supersedes it.
