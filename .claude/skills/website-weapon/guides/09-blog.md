...
For full Payload implementation details, read `cms-payload-weapon/guides/03-sveltekit-interop.md`.
...
> Lexical-to-HTML on the SvelteKit side is an open question (see cms-payload-weapon/guides/03-sveltekit-interop.md).
