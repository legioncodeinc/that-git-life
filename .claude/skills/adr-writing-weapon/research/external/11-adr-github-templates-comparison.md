...
- Note for weapon-forge: The canonical Y-statement source is Olaf Zimmermann's Medium article, not Jolie Rize as listed in the Command Brief. Both names appear in sources; Zimmermann is the academic attribution, Rize may be a popularization credit. Flag for human review.
