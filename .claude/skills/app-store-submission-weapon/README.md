...
Operational playbook for `app-store-submission-guardian` — the Legion Army's specialist for getting iOS and Android apps through App Store and Google Play review in 2025-2026.
...
└── research/                — scripture-historian's sources (read-only)
```
