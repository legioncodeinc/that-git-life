...
This example demonstrates the ~80% case. The key insight the Angel delivers that the team didn't ask for is the feature-flag explanation — teams in this state often don't know that long-lived branches are a scope problem, not a Git problem.
