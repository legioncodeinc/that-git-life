...
Spine of `guides/03-state-management.md` decision tree. This is where "Opinionation is the product" shows up hardest — the Angel says "Zustand" and cites this file.
