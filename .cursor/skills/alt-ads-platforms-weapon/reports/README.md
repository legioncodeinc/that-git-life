...
This folder accumulates channel audit and campaign performance reports produced by `alt-ads-platforms-guardian`.
...
This folder starts empty. Reports accumulate as `alt-ads-platforms-guardian` completes engagements.
