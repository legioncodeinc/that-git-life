...
The Angel can pull PR timeline data when given GitHub API access:
...
The Angel distinguishes rubber-stamps from legitimate fast approvals by checking PR size and content type against review time and comment count together.
