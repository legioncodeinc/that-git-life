...
**Auditor:** http-rest-fundamentals-guardian
**Date:** {YYYY-MM-DD}
...
- **Security findings:** {List any OWASP-level security header issues found here for security-guardian follow-up}
- **Auth findings:** {List any auth-header semantics issues for auth-guardian follow-up}
