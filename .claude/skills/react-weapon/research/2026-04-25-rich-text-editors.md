...
No new web_search_exa expansions performed. The source URLs in the research doc are the canonical references and the guide cites them directly. Realtime collab infra (Yjs / Liveblocks / PartyKit) is handed off to `devops-guardian` rather than expanded here.
