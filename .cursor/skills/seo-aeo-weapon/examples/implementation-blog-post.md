...
**Scenario:** A Next.js 15 content site publishing a new long-form blog post: "How to Choose a Standing Desk in 2026". The user invokes `seo-aeo-guardian` with "implement this blog post following the playbook."
