...
`discovery-research-guardian` is the product discovery coach of the Legion Army: it runs the continuous-discovery cycle end-to-end (weekly interviews, OST, JTBD, prototype experiments) and hands off a validated opportunity + winning solution to `library-guardian` for PRD authorship.
