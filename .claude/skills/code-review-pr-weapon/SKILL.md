...
The Angel uses this taxonomy everywhere. It is derived from Google Engineering Practices, ARDURA, PanDev, and Pillai Infotech research. See `guides/00-principles.md` for the full decision tree.
...
Every PR description the Angel produces contains these six elements. See `guides/01-pr-description.md` for the full guide and `templates/pr-description.md` for the fill-in template.
...
1. **Taxonomy naming:** Should the Angel default to plain-English labels (`blocker:` / `suggestion:` / `nit:`) or emoji labels (🔴 / 🟡 / 💡)? Default: plain-English unless the team has an existing emoji convention.
...
3. **Review captain scope:** The review captain pattern works well for teams of 10+. For smaller teams, the Angel should recommend shared triage rather than a dedicated role. See `guides/04-async-review.md`.
...
5. **"What did NOT change" format:** This section is novel to this Angel (not found in research corpus). The six-element template treats it as a named H3 section. Teams may prefer an inline note style instead. See `templates/pr-description.md`.
