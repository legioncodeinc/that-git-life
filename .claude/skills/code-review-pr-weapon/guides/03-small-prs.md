...
**Trunk-based checklist for the Angel:**
...
## How the Angel flags a large PR

When a PR exceeds a threshold, the Angel's output is:
...
The Angel never blocks the PR based on size alone. It flags the risk and proposes splits. The human decides.
