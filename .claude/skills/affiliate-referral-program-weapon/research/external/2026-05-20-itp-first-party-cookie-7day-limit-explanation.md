...
- **Practical implication for affiliate programs:**
  ...
  - For weapon-forge: the "cookie duration" guide section must clearly distinguish between advertised cookie duration and effective duration for Safari users
