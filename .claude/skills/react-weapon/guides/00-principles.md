...
- **React Native.** Most state/data patterns port, but navigation/styling/testing differ enough that a dedicated Angel is better. If the user asks, say so and ask whether they want an RN-specific Angel briefed.
...
- **Dedicated TanStack ecosystem Angel.** Open question for Army. See Command Brief.
