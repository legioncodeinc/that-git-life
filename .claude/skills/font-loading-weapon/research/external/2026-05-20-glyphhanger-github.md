...
- `subfont` (Munter/subfont) is an alternative that integrates into build tools and is more suitable for static site generators. The weapon should present glyphhanger and subfont as complementary tools.
