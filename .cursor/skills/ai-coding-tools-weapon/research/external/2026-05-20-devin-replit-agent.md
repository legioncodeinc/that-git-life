...
- The 14% benchmark figure is from early Devin 1.x — weapon-forge should note this predates Devin 2.0 and seek updated SWE-bench scores from the leaderboard source file.
