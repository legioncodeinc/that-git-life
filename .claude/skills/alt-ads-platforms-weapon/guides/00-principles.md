...
Six non-negotiables that govern every `alt-ads-platforms-guardian` engagement.
...
## 6. X/Twitter is the most volatile platform in this weapon's universe

X/Twitter Ads has had significant policy changes, advertiser trust disruptions, and platform instability since 2022. `guides/06-x-twitter-ads.md` is the only guide in this weapon that carries a mandatory quarterly review flag. Always tell users to verify current X/Twitter platform status at [business.twitter.com](https://business.twitter.com) before acting on any X Ads guidance.
