...
- `guides/06-http2-http3.md`: use this as the primary practical deployment reference alongside RFC 9114. The "four prerequisites" framing (TLS 1.3, UDP/443, Alt-Svc, implementation config) is weapon-forge-ready as a structured checklist.
