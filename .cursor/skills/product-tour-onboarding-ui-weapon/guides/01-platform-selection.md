...
> TODO: Open question — weapon-forge needs verification before shipping. Userflow's Next.js App Router compatibility in 2026 is unconfirmed. Before recommending Userflow for Next.js App Router teams, verify against `https://userflow.com/docs`. If a client-only wrapper is required, document it in this guide.
