...
- **Pricing models differ fundamentally**: Intercom per-seat + per-resolution, Crisp per-workspace, Plain per-seat with AI included, Pylon per-seat with AI as add-on. The weapon must explain this clearly to prevent sticker shock.
