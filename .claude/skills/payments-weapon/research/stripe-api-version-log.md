...
Track which API version the Weapon's guides target. Refresh when Stripe ships a new annual version line.
...
- A breaking change lands in any line that affects Checkout, webhooks, subscriptions, or portal — the four core areas of this Weapon.
