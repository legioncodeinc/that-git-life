...
Spine of `guides/05-error-handling.md`. Security section is a pointer — actual audit is `security-guardian`'s job. react-guardian surfaces the issue; security-guardian decides the fix.
