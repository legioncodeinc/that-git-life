...
- Should wiki-guardian dedupe near-name entities (e.g., `getUser` vs `get-user`)? Recommend kebab-case for filenames AND camelCase preserved in body — this avoids 90% of dedup ambiguity. Document in the Angel guide.
