...
- The framework's key insight - that documentation fails when it mixes modes - gives the Angel its first and most important diagnostic step: classify before critiquing.
