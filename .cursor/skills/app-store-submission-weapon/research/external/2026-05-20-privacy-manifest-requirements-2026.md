...
- The "no custom reasons allowed" constraint is not obvious and is the source of many developer frustrations. The weapon should note this and link to Apple's predefined reasons list.
...
- The verification checklist is directly usable as the pre-flight checklist template in the weapon's `templates/` folder.
