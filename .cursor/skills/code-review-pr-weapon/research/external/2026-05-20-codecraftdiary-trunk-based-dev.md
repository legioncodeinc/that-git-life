...
- **"Same day merge" target** is a more aggressive SLA than the 4-business-hour first-review norm from other sources. The weapon should present both and let teams choose based on their TBD ambition level.
...
- **Contradiction with other sources**: 300-line soft limit here vs. 400-line threshold elsewhere. The weapon should document this as a configurable constant (default: 400 lines per PR, adjustable to 200-300 for teams pursuing stricter TBD).
