...
- **ux-ui-guardian** owns whether the page's visual composition matches the brief. You catalog; they review.
- **security-guardian** reviews `authRequirement` for every page that exposes sensitive data.
- **library-guardian** cross-links the page to its owning feature PRD.
