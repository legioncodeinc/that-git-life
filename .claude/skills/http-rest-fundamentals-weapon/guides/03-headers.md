...
These headers are HTTP-layer concerns for `http-rest-fundamentals-guardian`. The enforcement and prioritization of OWASP-level violations is `security-guardian`'s domain.
