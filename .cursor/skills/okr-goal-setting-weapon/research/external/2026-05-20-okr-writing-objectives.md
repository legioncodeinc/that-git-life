...
- The "best customer test" is a heuristic that works across B2B, B2C, and internal team Objectives and should be the primary quality gate in the weapon.
- The distinction between task Objectives and aspirational Objectives is where many teams get confused when migrating from project management (Jira, Linear) to OKRs - the weapon should explicitly address this migration context.
