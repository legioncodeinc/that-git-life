...
The canonical architecture for bi-directional CRM sync. This is the most complex guide in the weapon because conflict resolution has no universally correct answer -- the guardian's job is to make the policy explicit before any code is written.
