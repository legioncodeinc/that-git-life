...
- The `private_metadata` 3000-character limit is a production gotcha weapon-forge should flag explicitly.
- The view stack max of 3 is a UX constraint that shapes modal chaining patterns.
- `notify_on_close` is often overlooked; weapon-forge should include it in the modal lifecycle state machine diagram.
