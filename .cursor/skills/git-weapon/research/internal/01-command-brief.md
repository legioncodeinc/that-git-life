...
Structured summary of the Command Brief at `ai-tools/command-briefs/git-guardian-command-brief.md`. This is the internal design document that `weapon-forge` uses to understand what the Angel does, what it does NOT do, and what playbook structure to build.

---

## Identity

- **Angel name:** `git-guardian`
...
## Key Inputs the Angel Needs from Developers
