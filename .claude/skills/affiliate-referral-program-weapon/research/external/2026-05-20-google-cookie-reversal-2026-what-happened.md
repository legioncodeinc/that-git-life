...
- **For weapon-forge attribution guide:** The key actionable is: set affiliate tracking cookies server-side (not JS), combined with S2S postback for conversion attribution. This combination provides ~20-40% recovery of previously lost conversions (per Stape 2026 data).
