...
- This is the primary source for `guides/04-action-items.md`. The five failure modes are the diagnostic checklist the Angel uses when a team has low follow-through rate (ACTION 4).
