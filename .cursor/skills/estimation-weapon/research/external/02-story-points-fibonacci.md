...
- The technique comparison table (Planning Poker vs. T-shirt Sizing vs. Affinity vs. Individual) is useful for weapon-forge to adapt into `guides/02-relative-sizing.md`
- Key contradiction with #NoEstimates sources: Mike Cohn's work supports velocity-based forecasting from story points; Vasco Duarte argues story points add noise over raw item counts. weapon-forge should resolve this honestly: story points work well for sprint capacity; they are NOT reliable long-range forecasting tools
- Ron Jeffries critique of story points (ronjeffries.com) was not directly retrieved in this research pass; weapon-forge should note this gap and potentially re-fetch
