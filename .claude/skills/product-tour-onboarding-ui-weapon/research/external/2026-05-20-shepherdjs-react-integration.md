...
- Note on research: the Command Brief specifies Shepherd.js 14 but the library is now at v15.2.2 (March 2026). weapon-forge should document v15 as the current version and note the 14→15 migration path.
...
- This is the dedicated source for the Shepherd.js section of `guides/03-driver-js-shepherd-js.md`. The Command Brief specifies Shepherd.js 14; weapon-forge should note that the library has advanced to v15.2.2 as of March 2026 and provide upgrade notes.
...
- Contradictions to resolve: the `2026-05-20-oss-tour-libraries.md` file lists Shepherd.js as version-agnostic and "updated 17 days ago." This file identifies the specific current version as v15.2.2. weapon-forge should use v15.2.2 as the canonical version reference.
