-- payments-weapon — processed_webhook_events table
--
...
--
-- Hand to db-guardian for the actual migration, indexing strategy, and
...
CREATE TABLE IF NOT EXISTS processed_webhook_events (
    ...
    -- and access controls with security-guardian before enabling.
    -- payload   jsonb,
