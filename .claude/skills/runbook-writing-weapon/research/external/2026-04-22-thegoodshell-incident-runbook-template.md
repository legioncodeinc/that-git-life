...
- The three storage requirements should be encoded as a checklist in the weapon's `guides/00-principles.md` or as a separate `guides/07-runbook-storage.md`.
- The role assignment section belongs in break-fix templates for SEV-1 incidents; weapon-forge should include it as an optional section gated on severity.
- The postmortem-to-runbook completion rate KPI gives weapon-forge a concrete metric to include in `guides/06-postmortem-linkage.md`.
