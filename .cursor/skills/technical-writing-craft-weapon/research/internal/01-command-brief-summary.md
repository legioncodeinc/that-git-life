...
`technical-writing-craft-guardian` is the Legion Army's documentation craft specialist. It owns the *writing itself*, not the platform that hosts the docs. Its peer boundaries are:

| Angel | What they own | Handoff signal |
|---|---|---|
...
The brief specifies eight action steps the Angel must execute. The Weapon's guides must give the Angel the knowledge to perform each:
...
| File | Purpose |
|---|---|
| templates/scorecard.md | Blank scorecard for the Angel to populate |
| templates/ghostwrite-brief.md | Intake form for ghostwriting mode |
| templates/code-example-checklist.md | Runnable checklist the Angel applies to every code block |
...
## Critical directives for the Angel (from brief)
