...
- CLS improvement from 0.28 to 0.02 is the key motivating statistic (14x improvement) — include in the weapon's introduction section.
- Safari 17+ for `size-adjust` support is significant: Safari 17 was released in September 2023, meaning broad Safari support is now established. The weapon can recommend this without Safari caveats for most modern target browsers.
