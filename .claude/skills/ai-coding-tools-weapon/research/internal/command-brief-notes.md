...
`ai-coding-tools-guardian` is the Army's authority on every AI coding tool decision a developer faces. It sits at the intersection of developer tooling and AI agent ergonomics.
...
1. Should this Angel cover GitHub Copilot in depth or treat it as baseline? (Proposal: baseline comparison point only)
