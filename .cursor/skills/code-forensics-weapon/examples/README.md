...
The Example Booking Co. matter (Sarah Bennett / Example Booking Co. LLC) is the calibration anchor for this Weapon. It demonstrates every phase running end-to-end:
...
Future iterations of this Weapon will be calibrated against the growing example library.
