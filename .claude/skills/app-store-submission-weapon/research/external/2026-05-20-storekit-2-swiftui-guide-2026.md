...
- The SubscriptionOfferView + iOS 26 note is important for minimum deployment target decisions — weapon-forge should note this as a capability gate.
...
- Win-back offers section explains that they are delivered automatically by the App Store — weapon-forge should clarify that developers don't code trigger logic, only handle the resulting transaction.
