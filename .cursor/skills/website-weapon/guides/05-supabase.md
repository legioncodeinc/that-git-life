...
Handoff: `db-guardian` for detailed schema design and indexing decisions. Use the Supabase MCP (`plugin-supabase-supabase`) for migration management.
...
Delegate detailed schema design to `db-guardian`. The canonical tables are:
