...
# Command Brief Summary: preact-guardian

Synthesized from `ai-tools/command-briefs/preact-guardian-command-brief.md`.
...
4. **Critical directive summary**: Never recommend Preact without naming the concrete benefit; always check compat compatibility surface; scope signals to specific use case; don't modify Next.js/React tooling; defer to react-guardian for React architecture.
