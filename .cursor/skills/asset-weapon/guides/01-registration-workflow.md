...
- It is not a feature PRD. For feature PRDs, draft content and hand off to `library-guardian`.
- It is not a QA report. For QA, hand off to `quality-guardian`.
- It is not a UX/UI decision. For visual semantics, defer to `ux-ui-guardian`.
- It is not a security audit. Registry-shaped feature PRDs still need a `security-guardian` pass like any other code change.
