...
The website-weapon's source PRDs are reverse-engineered from a production SvelteKit + Payload + Supabase + Vercel codebase. Secondary sources are consulted for freshness on specific topics.

**Note:** Payload CMS deep research lives in a separate dedicated weapon: `.cursor/skills/cms-payload-weapon/research/`. The research plan here covers SvelteKit-specific and multi-framework concerns only.
...
| Payload CMS docs | https://payloadcms.com/docs | 07, 09 — deep research in cms-payload-weapon/research/ |
