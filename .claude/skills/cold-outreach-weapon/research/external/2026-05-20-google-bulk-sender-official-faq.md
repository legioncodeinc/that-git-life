...
- This is the cite-primary source for the Google bulk sender rules in `guides/02-infrastructure-and-deliverability.md`. Always link to this URL in the published weapon.
