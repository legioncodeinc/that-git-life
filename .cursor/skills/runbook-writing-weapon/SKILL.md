...
This weapon is pre-loaded by `runbook-writing-guardian`. Do not load it independently unless you are the Angel.
...
+- reports/
|  +- README.md                    (what the Angel's audit reports look like)
...
*Forged by `weapon-forge` from `runbook-writing-guardian-command-brief.md` and `research/`. Part of the Legion AI Tools Factory by [Mario Aldayuz a.k.a @thenotoriousllama](https://github.com/thenotoriousllama).*
