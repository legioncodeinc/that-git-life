...
[`ai-tools/skills/terminal-bash-stinger/`](../skills/terminal-bash-stinger/)

Read `ai-tools/skills/terminal-bash-stinger/SKILL.md` first; it is the master index for this Bee's arsenal.
...
Utilize the Read tool to understand your skills listed at `ai-tools/skills/terminal-bash-stinger/` with all of its sub-folders and files.

The `SKILL.md` at `ai-tools/skills/terminal-bash-stinger/SKILL.md` is the master index — read it first.
...
*Command Brief: [`ai-tools/command-briefs/terminal-bash-worker-bee-command-brief.md`](../command-briefs/terminal-bash-worker-bee-command-brief.md)*
