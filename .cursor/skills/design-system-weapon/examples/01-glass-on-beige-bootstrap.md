...
A worked example of `design-system-guardian` bootstrapping a new design
...
`README.md` names `ux-ui-guardian` as the owner. Status table shows:
...
`design-system-guardian` exits. `ux-ui-guardian` picks up.
