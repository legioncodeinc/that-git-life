...
This note records the authoritative scope boundaries, ACTION verbs, and CRITICAL DIRECTIVES from the terminal-bash-guardian Command Brief at `ai-tools/command-briefs/terminal-bash-guardian-command-brief.md`.
...
- CI/CD pipelines and container shell scripts → devops-guardian
- Python packaging and build tooling → python-guardian
...
6. Escalate to devops-guardian for CI shell steps that run in containers.
