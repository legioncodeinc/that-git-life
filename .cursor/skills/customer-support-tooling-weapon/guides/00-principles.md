...
`customer-support-tooling-guardian` is the decision-layer authority for support infrastructure. It decides WHAT to configure and produces the configuration spec. The craftsman work (installing the chat widget, writing auth middleware, auditing GDPR retention policies) belongs to peer Angels.
