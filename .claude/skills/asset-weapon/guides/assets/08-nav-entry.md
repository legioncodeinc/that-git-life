...
- **ux-ui-guardian** — nav visuals are owned by them (`nav-top-bottom-left.md`, `nav-icon-customizer.md`).
- **library-guardian** — nav-related feature PRDs (e.g., a custom-menu-items feature) cross-link here.
