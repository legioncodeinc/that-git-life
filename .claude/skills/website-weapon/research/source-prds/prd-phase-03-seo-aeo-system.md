...
This phase delegates implementation to `seo-aeo-guardian` (SvelteKit track). See `seo-aeo-weapon/guides/sveltekit/` for full implementation guides.
...
See `seo-aeo-weapon/templates/sveltekit/generateSEO.ts` (also at `website-weapon/templates/generateSEO.svelte.ts`).
...
See `seo-aeo-weapon/templates/sveltekit/schema.ts` for the full utility library.
...
See `seo-aeo-weapon/templates/sveltekit/robots-server.ts`.
