...
- The "snippets-only documentation" warning is important: the Angel should flag when a code block appears in isolation without introductory context as a Suggestion finding.
