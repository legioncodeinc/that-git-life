...
This file documents the canonical references identified in the Command Brief and their current status for weapon-forge consumption.
...
- **Weapon-forge action:** Scrape this URL directly during weapon-forge or use the Exa content already captured in external files.
...
- **Weapon-forge action:** Scrape for exact wording and any 2025-2026 updates.
...
- **Weapon-forge action:** Cross-reference against the research set content.
...
- **Weapon-forge action:** Optional scrape if deeper code review guidance is needed.
...
- **Weapon-forge action:** Scrape for direct quotations of the four types and their lifespans.
...
- **Weapon-forge action:** Cross-reference the external file against official docs.
