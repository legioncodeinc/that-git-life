...
Tracks "what was current when each guide was authored" so the Weapon can be updated when React / its ecosystem moves.
...
Re-run the Weapon's research pass every 6-9 months, or sooner when a React major ships. Update this file, then scan each guide for version-anchored claims and refresh as needed.
