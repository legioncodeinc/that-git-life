...
This is different from the `--text-xs`, `--text-sm`, `--text-base` semantic naming convention used in other systems. Weapon-forge should decide which naming convention to adopt or bridge between the two.
