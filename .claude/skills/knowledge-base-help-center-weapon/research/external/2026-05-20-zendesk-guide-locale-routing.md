...
- The gap between Copilot AI translation and TMS integration (Zendesk does NOT auto-sync category/section names or meta descriptions) is a workflow complexity the weapon should flag: "native AI translation covers article body; full multilingual setup still requires manual work on navigation elements."
