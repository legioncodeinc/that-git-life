...
For full Payload implementation details, invoke `cms-payload-guardian` which reads from `cms-payload-weapon/`.
...
- Payload Live Preview setup (advanced, see `cms-payload-weapon/guides/05-live-preview.md`)
...
See `website-weapon/guides/07-admin-payload.md` for the full config example.
