...
These six principles are the non-negotiables. Every guide in this weapon derives from them. Every checklist item in `guides/07-done-checklist.md` traces back to at least one.
