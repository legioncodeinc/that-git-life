...
- The monthly review cadence (2-3 runbooks/month per rotating team member) gives weapon-forge a concrete freshness recommendation to embed in `guides/05-runbook-as-test.md`.
