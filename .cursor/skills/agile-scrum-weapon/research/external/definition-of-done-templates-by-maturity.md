...
- The three templates (startup, standard, enterprise) map directly to `templates/definition-of-done-startup.md` and `templates/definition-of-done-enterprise.md` in the weapon folder.
